...
<li>Application refers to Depths of Burgos, the software program provided by the Company.</li>

<li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Depths of Burgos.</li>
...
Open the app and log in. On the main screen, click Log Out, and then click delete account and confirm to delete account and all data associated with it. This is not reversable!
